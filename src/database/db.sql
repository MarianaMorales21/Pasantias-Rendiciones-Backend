...
INSERT INTO `ben_ren` VALUES ('G-20000513-0','FUNDES-TÁCHIRA','7MA AVENIDA CENTRO CÍVICO',1),('G-200005130','TESORO NACIONAL','CARACAS',1),('G-20016852-8','SEDEBAT','AV PLS PILAS ENTRE CALLE VILLA ESCONDIDA Y AV. NORTE EDIF. PPAL JUNTO AL COLEGIO DE CONTADORES SAN CRISTOBAL',1),('V-11498709-0','JOSE ALFREDO RODRIGUEZ SALAS','LA ROMERA',1),('V-14259273-4','CARLOS JAVIER CARRERO MORA','EL DIAMANTE',1),('V-30781815','Mariana','JUNCO',1);
...
INSERT INTO `ctd_ren` VALUES ('V-15233763','Pernia Leal','Deccy Coromoto','Táriba Centro',1);
...
CREATE TABLE `ndb_ren` (
  ...
  `rif_ndb` char(12) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`cod_ndb`),
  KEY `fk_ndb_ben` (`rif_ndb`),
  KEY `fk_ndb_rnd` (`rnd_ndb`),
  KEY `fk_ndb_pro` (`pro_ndb`),
  CONSTRAINT `fk_ndb_ben` FOREIGN KEY (`rif_ndb`) REFERENCES `ben_ren` (`rif_ben`),
...
INSERT INTO `ndb_ren` VALUES (20,'ND-25155','2025-12-30','V-14259273-4',19,1,'COMPRA DE EQUIPOS DE COMPUTACION (SWUITCH DESKTOP 8 PUERTOS 10/100MPS) Y 01 TETERA ELECTRONICA',39674.25,'BANCO BICENTENARIO','48278492',0.00,0.00,0.00,0.00),(21,'ND-25213','2026-01-09','G-20016852-8',19,1,'PAGO DE TIMBRE FISCAL MES DICIEMBRE 2025 (FAC. 135)',38.19,'BANCO BICENTENARIO','86020418',0.00,0.00,0.00,0.00),(22,'ND-25217','2026-01-09','G-200005130',19,1,'PAGO IVA 75% (FAC 135)',2820.87,'BANCO BICENTENARIO','668022',0.00,0.00,0.00,0.00),(23,'ND-1524','2026-05-21','G-20000513-0',20,1,'BUGIUI',200.00,'BANCO DE VENEZUELA','21654684',100.00,0.00,0.00,300.00),(24,'ND-24617','2026-05-21','G-20000513-0',21,1,'VBOISF',300.00,'BANCO ACTIVO','54648494',0.00,0.00,0.00,0.00),(25,'ND-2110','2026-05-21','G-20016852-8',22,1,'WTTW',500.00,'BANCO DEL TESORO','56646',0.00,0.00,0.00,0.00),(26,'ND-1220','2026-05-21','G-20000513-0',22,2,'SDNGNSDOG',3360.00,'BANCO PLAZA','51651',50.00,80.00,10.00,3500.00),(27,'ND-12205','2026-05-21','G-20016852-8',23,1,'DVZC',39033.31,'BANCO PLAZA','',0.00,0.00,0.00,0.00),(28,'ND-1530','2026-05-22','V-11498709-0',23,2,'TAKASGDF',140.00,'BANCO DE VENEZUELA','587548',0.00,0.00,0.00,0.00),(29,'ND-854','2026-05-22','G-20000513-0',24,1,'OLA',35000.00,'BANCO PLAZA','894656',100.00,0.00,0.00,35100.00),(30,'ND-852','2026-05-22','V-11498709-0',25,1,'UISFHGO',10000.00,'BANCO PLAZA','555555656',0.00,0.00,0.00,0.00),(31,'ND-789','2026-05-22','G-20000513-0',26,2,'UGU',2000.25,'BANCO ACTIVO','156465',0.00,0.00,0.00,0.00),(33,'ND-584','2026-05-22','G-20000513-0',28,1,'SDGS',300.00,'BANCO PLAZA','2165',0.00,0.00,0.00,0.00),(34,'ND-258','2026-05-22','G-20000513-0',30,1,'FDSGD',300.00,'BANCO ACTIVO','4645',0.00,0.00,0.00,0.00),(35,'ND-87964','2026-05-22','G-20000513-0',21,1,'IHDSOIG',100.00,'BANCO PLAZA','1151',0.00,0.00,0.00,0.00),(41,'ND-845','2026-05-22','G-20000513-0',34,1,'DFSD',300.00,'BANCO ACTIVO','24542',0.00,0.00,0.00,0.00),(42,'ND-741','2026-05-22','G-20000513-0',35,1,'FSDF',250.00,'BANCO ACTIVO','6545',0.00,0.00,0.00,0.00),(43,'ND-9630','2026-05-22','G-20000513-0',36,1,'DGSFG',200.00,'BANCO PLAZA','54552',0.00,0.00,0.00,0.00),(44,'ND-25261','2026-01-30','G-20000513-0',37,1,'PAGO DE COMISIONES  ',60.00,'BANCO BICENTENARIO','25261',0.00,0.00,0.00,0.00);
...
CREATE TABLE `opg_ren` (
  ...
  `ced_opg` char(15) COLLATE utf8mb4_spanish2_ci NOT NULL,
  ...
  PRIMARY KEY (`cod_opg`),
  KEY `fk_opg_ctd` (`ced_opg`),
  KEY `fk_opg_par` (`par_opg`),
  KEY `fk_opg_sta` (`sta_opg`),
  CONSTRAINT `fk_opg_ctd` FOREIGN KEY (`ced_opg`) REFERENCES `ctd_ren` (`ced_ctd`),
...
INSERT INTO `opg_ren` VALUES (13,4132,'V-15233763','2026-05-21','2026-05-22','2024-12-20','132',42533.31,'TRANFERENCIA DE CAPITAL A ENTES DESCENTRALIZADOS SIN FINES EMPRESARIALES. RECURSOS CORRESPONDIENTES A LOS MESES DE NOVIEMBRE Y DICIEMBRE DEL EJERCICIO FISCAL 2025',4,3),(14,584,'V-15233763','2026-05-21','2026-05-22','2024-12-24','132',500.00,'HFPSRG',4,3),(15,2110,'V-15233763','2026-05-21','2026-05-21','2026-05-21','132',42533.31,'RERH',4,3),(16,1203,'V-15233763','2026-05-20','2026-05-22','2025-12-24','132',45360.25,'PAGO COSAS',4,3),(17,856,'V-15233763','2026-05-22','2026-05-22','2026-05-22','132',500.00,'HGUGI',4,3),(18,1808,'V-15233763','2026-05-22','2026-05-22','2026-05-22','132',500.00,'HISGHO',4,3),(19,2799,'V-15233763','2025-09-17','2025-09-19','2024-12-20','132',63800.01,'TRANSFERENCIAS DE CAPITAL A ENTES ',3,3);
...
INSERT INTO `par_ren` VALUES (1,'13.01.51.4.02.01.01','ALIMENTOS Y BEBIDAS'),(2,'13.01.51.4.03.18.01','MATERIALES EDUCATIVOS'),(3,'13.05.51.4-07.01.03.02.003.002-000','ORDEN DE PAGO'),(4,'13.01.51.4.04.09.02','EQUIPOS DE COMPUTACION'),(5,'13.01.51.4.04.09.03','EQUIPOS DE COCINA'),(6,'13.01.51.4.03.08.02','COMISIONES BANCARIAS');
...
INSERT INTO `sta_ren` VALUES (1,'Activo'),(2,'Inactivo'),(3,'Pendiente'),(4,'Pagado');
...
INSERT INTO `usu_ren` VALUES ('12972129','William Rodríguez','$2a$10$MqRuL6/gQJ0QZabWJWN5WeFZaQ3j9S5rGkFnBurhDGAkDIsgTdx6u','william@fundes.gob.ve',1,1),('19976678','Marily Buenaño','123456','marily@fundes.gob.ve',2,1);
...
-- Dump completed on 2026-05-24 19:01:15
